...
static void LCD_GPIOInit(void){
    ...
    // K5
    SYSCTL_RCGCGPIO_R |= 0x200;                 // activate port K
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    GPIO_PORTK_DIR_R |= 0x20;                   // make PK5 an output
    GPIO_PORTK_AFSEL_R &= ~20;                  // disable alternate functions
    GPIO_PORTK_DEN_R |= 0x20;                   // enable digital I/O on PK5

    // M7
    SYSCTL_RCGCGPIO_R |= 0x800;                 // activate port M
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // N4, N5
    SYSCTL_RCGCGPIO_R |= 0x1000;                // activate port N
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // P0, P1, P3, P4
    SYSCTL_RCGCGPIO_R |= 0x2000;                // activate port P
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
    ...
    // Q0, Q2, Q3
    SYSCTL_RCGCGPIO_R |= 0x4000;                // activate port Q
    wait++;                                     // wait for port activation
    wait++;                                     // wait for port activation
